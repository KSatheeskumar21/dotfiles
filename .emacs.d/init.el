...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smex projectile yaml-mode electric-pair-mode lsp-haskell centaur-tabs prettify-symbols prettify-utils pretty-symbols flycheck elpy doom-themes doom-modeline use-package sudo-edit peep-dired general gcmh evil-tutor evil-collection emojify elfeed-goodies dired-open dashboard all-the-icons-dired)))
(custom-set-faces
